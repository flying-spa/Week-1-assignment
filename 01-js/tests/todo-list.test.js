...
describe('Todo', () => {
	...
	test('update', () => {
		...
		expect(todoList.getAll()[1]).toBe('Updated Task 2');
	...
	test('get', () => {
		...
		expect(todoList.getAll()[0]).toBe('Task 1');
		expect(todoList.getAll()[2]).toBe('Task 3');
		expect(todoList.getAll()[3]).toBeUndefined();
	});
